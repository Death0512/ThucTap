...
def analyze_with_llm(extracted_text, post_date, language):
...
def analyze_text_posts(db_file=DB_FILE):
    ...
    print(f"Analysis: {llm_client.LLM_MODEL}")
    print(f"DB      : {db_file}")
    print("═"*65)
    ...
    for i, post in enumerate(posts, 1):
        ...
        print(f"     Analyzing context with {llm_client.LLM_MODEL}...")
        analysis = analyze_with_llm(extracted_text, post['date'], language)
